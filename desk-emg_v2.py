...
class Ui_MainWindow(QMainWindow, form_class):
    ...
    def sensor(self):
        try:
            ...
            self.svf = []
            self.sav = []
            self.ser = Serial('COM' + str(self.ePort.text()), 250000)
            ...
            if self.ser.readable():
                ...
                del self.avg_data[0]
            self.thres = [int(self.data[4][:-2]) + int(self.tl.value()) ] * 300
    ...
    def update_sensor(self):
        try:
            ...
            if self.ser.readable():
                ...
                self.plot.plot(self.thres[-self.x_scale:], pen=pyqtgraph.mkPen(color=(0, 105, 255), width=2))
    ...
    def move_leg(self):
        ...
        if self.tcp_type_1 == 1:
            ...
            self.client_socket_1.send(self.legdata.encode())
