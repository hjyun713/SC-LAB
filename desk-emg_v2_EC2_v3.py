...
class Ui_MainWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.autot.clicked.connect(self.Nonpixthres)
    ...
    def execute_5(self):
        try:
            while True:
                time.sleep(1)
                thres = statistics.pstdev(self.sav) * self.r_value + 400
    ...
    def Nonpixthres(self):

        threading.Thread(target=self.execute_5).start()
